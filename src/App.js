...
export const displayPlay = (e) => {
  const wrapper =
    ...
    e.target.closest(".result-wrapper");
...
export const hidePlay = () => {
  document
    .querySelectorAll(".play-container")
    .forEach((container) => (container.style.scale = 0));
};
      ...
      <div className="container">
        ...
        <main>
          ...
          <Routes>
            ...
            <Route
              path="/info/:movieID"
              element={<MovieInfo movie={focusedMovie} />}
            />
            <Route
              path="/bookmarks"
              element={
          ...
          <footer>
            <p>Powered by</p>
            <a
              href="https://www.themoviedb.org/documentation/api?language=en-US"
              target="_blank"
              rel="noreferrer"
            >
              <img
